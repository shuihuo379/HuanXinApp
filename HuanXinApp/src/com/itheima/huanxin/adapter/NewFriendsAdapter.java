...
public class NewFriendsAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = View.inflate(context, R.layout.item_newfriends_msg, null);
        ...
        if (msg.getStatus() == InviteMessageStatus.AGREED || msg.getStatus() == InviteMessageStatus.BEAGREED) {
    ...
    private void addFriendToList(final String hxid) {
        ...
        LoadDataFromServer task = new LoadDataFromServer(null,Constant.URL_Get_UserInfo, map_uf);
