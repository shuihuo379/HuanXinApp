...
public class AddFriendsTwoActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    final RelativeLayout re_search = (RelativeLayout) this.findViewById(R.id.re_search);
	 ...
	 private void searchUser(String uid) {
        ...
        LoadDataFromServer task = new LoadDataFromServer(AddFriendsTwoActivity.this, Constant.URL_Search_User, map);
            ...
            public void onDataCallBack(JSONObject data) {
                try {
                    ...
                    if (code == 1) {
                        ...
                        Toast.makeText(AddFriendsTwoActivity.this, "用户不存在",Toast.LENGTH_SHORT).show();
                    } else if (code == 3) {
                        Toast.makeText(AddFriendsTwoActivity.this,"服务器查询错误...",Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(AddFriendsTwoActivity.this,"服务器繁忙请重试...", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    dialog.dismiss();
                    Toast.makeText(AddFriendsTwoActivity.this, "数据解析错误...",Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        });
